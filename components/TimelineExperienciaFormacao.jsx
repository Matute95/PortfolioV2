		...
		<VerticalTimeline lineColor={theme.colors.branding}>
			...
			<VerticalTimelineElement
				...
				<TimelineContent>
					...
					<BoldText>
						{language.experiencePage.timeline.labelFunc}: <span><div>{language.experiencePage.timeline.job1_8}</div>
					</span>
					</BoldText>
				</TimelineContent>
			</VerticalTimelineElement>
			...
			<VerticalTimelineElement
				...
				<TimelineContent>
					...
					<BoldText>
						{language.experiencePage.timeline.labelTitle}:{" "}
						<span>{language.experiencePage.timeline.title2}</span>
					</BoldText>
					<BoldText><a href="https://drive.google.com/file/d/1QK0sODocfH-sPJd8J_6XWnNbYAhNMEVg/view" target={"_blank"}>
						<span>{language.experiencePage.timeline.cert}</span></a>
					</BoldText>
				</TimelineContent>
			</VerticalTimelineElement>
			...
			<VerticalTimelineElement
				...
				<TimelineContent>
					...
					<BoldText>
						{language.experiencePage.timeline.labelDep}: <span>DTIC</span>
					</BoldText>
					<BoldText>
