...
export default function SocialNetworkRowStack() {
	return (
		<SocialMediaContainer>
			...
			<ButtonSocialMediaIcon href="https://github.com/Matute95" target="_blank">
				<Github />
			</ButtonSocialMediaIcon>

			<ButtonSocialMediaIcon href="mailto:matias.01001101@gmail.com" target="_blank">
				<MailSend />
			</ButtonSocialMediaIcon>

			<ButtonSocialMediaIcon href="https://wa.me/59178446698/" target="_blank">
				<LogoWhatsapp />
			</ButtonSocialMediaIcon>

			<ButtonSocialMediaIcon href="https://t.me/Matias_Rejas" target="_blank">
				<Telegram />
			</ButtonSocialMediaIcon>

			<ButtonSocialMediaIcon href="https://www.linkedin.com/in/matias-rejas-guerra-30583b268/" target="_blank" data-splitbee-event="linkedin-access">
				<LinkedinSquare />
			</ButtonSocialMediaIcon>
		</SocialMediaContainer>
	);
